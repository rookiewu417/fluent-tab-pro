# 🌍 Help Translate Fluent Tab Pro

Fluent Tab Pro is designed to be accessible to everyone, and we want it to feel native in every language.
...
### 👉 [Join the Fluent Tab Pro project on Crowdin](https://crowdin.com/project/fluent-tab-pro)
...
1.  Go to the [Crowdin Project Page](https://crowdin.com/project/fluent-tab-pro).
